...
const CastCard = ({ name, character, profile_path, gender }) => {
  ...
  return (
    <div className="shadow-md border-[1px] border-slate-50 m-2 rounded-md w-[200px]">
      {/* <div className="relative"> */}
      <img
        src={profile_path === null ? noProfileImg : getProfileImg}
        alt={name}
        className="w-full h-[175px] shadow-sm rounded-t-md hover:cursor-pointer object-cover"
      />
